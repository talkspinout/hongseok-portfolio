...
const ABOUT = {
  ...
  heroSub: "인하우스와 에이전시를 오가며 B2C 커머스·앱부터 B2B 엔터프라이즈·SaaS까지 다양한 제품과 시장의 성장 과제를 해결해왔습니다.\n\n채널 단위의 실행에 머무르지 않고 사용자 여정과 성과 구조를 함께 설계합니다.",
  skills: [
    "GTM 전략 · 브랜드 포지셔닝",
    "퍼포먼스 · 콘텐츠 마케팅",
    "데이터 분석 · 성과 최적화",
...
const CAREER = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "상세페이지·구매 퍼널 개선, 광고 크리에이티브·타깃 최적화",
...
const GATE = {
  ...
  steps: [
    ...
    { title: "확인", desc: "신청 내용을 확인합니다. 통상 영업일 기준 1일 이내에 처리됩니다." },
...
/* ------------------------------------------------------------
   ...
   - copyrightNotice: 자료 이용 조건 안내 문구. 별도 확인 체크박스와 함께 노출
   ------------------------------------------------------------ */
const LEAD_FORM = {
  title: "포트폴리오 열람 신청",
  ...
  privacy: {
    ...
    retention: "열람 권한 제공일로부터 3개월까지 보관하며, 신청자가 삭제를 요청하는 경우 지체 없이 파기합니다.",
    refusal: "귀하는 개인정보 수집·이용 동의를 거부할 권리가 있습니다. 다만, 필수 정보 수집에 동의하지 않을 경우 포트폴리오 열람 신청 및 권한 제공이 어렵습니다.",
    version: "2026-07-16",
    consentLabel: "포트폴리오 열람 권한 제공을 위한 개인정보 수집 및 이용에 동의합니다.",
  },
  copyrightNotice:
    "본 포트폴리오의 편집·구성 및 직접 작성한 콘텐츠의 저작권은 고홍석에게 있습니다. 열람 자료는 채용 검토 및 협업 논의를 위한 참고 목적으로만 제공되며, 사전 동의 없는 복제, 배포, 외부 공유, 게시 및 2차 이용을 금합니다.",
  usageConsentLabel: "열람 자료의 비공개·비배포 조건을 확인했습니다.",
  successTitle: "신청이 접수되었습니다.",
  successDesc: "통상 영업일 기준 1일 이내에 확인 후, 작성하신 이메일로 열람 권한을 공유해 드립니다.",
