    ...
    stages: [
      {
        ...
        checkQuestion:
          "브랜드·제품 인지 활동(ATL·인플루언서·콘텐츠형 광고 등)의 효과를 검색량 변화 같은 지표로 확인하며 운영하고 있습니까?",
        activities: [
          { activity: "ATL 광고", purpose: "넓은 타겟 인지 / 지하철·옥외·유튜브 프리롤", kpi: "집행 후 검색량 증가, VoC", failurePath: ["메시지", "타겟", "매체"] },
          { activity: "인플루언서·라이브커머스", purpose: "신뢰 기반 인지 / 그립, 네이버 쇼핑라이브", kpi: "라이브 동시 시청자, 클릭률", failurePath: ["인플루언서 댓글 톤", "메시지 점검"] },
          { activity: "콘텐츠형 광고", purpose: "제품 설명 후 유입 / 유튜브 쇼츠, 인스타 릴스", kpi: "도달, 영상 시청률, 검색량 변화", failurePath: ["카테고리 키워드", "타겟·제품 fit"] },
...
const FUNNEL_DIAGRAM_STAGES = {
  "b2c-commerce": [
    { label: "인지", desc: "브랜드·제품 검색 유도", items: ["ATL 광고", "인플루언서·라이브커머스", "콘텐츠형 광고", "어필리에이트"] },
