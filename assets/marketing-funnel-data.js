...
const FUNNEL_DIAGRAM_STAGES = {
  "b2c-commerce": [
    { label: "인지", desc: "브랜드·제품 검색 유도" },
    { label: "고려", desc: "검색·비교·상세페이지" },
    { label: "구매", desc: "첫 구매·객단가·CRM 확보" },
    { label: "잔류·재구매", desc: "재구매·정기구독" },
    { label: "지지", desc: "리뷰·추천·UGC" },
  ],
  "b2c-app": [
    { label: "인지", desc: "앱 노출·설치 유도" },
    { label: "고려·전환", desc: "다운로드 → 가입" },
    { label: "활성화", desc: "첫 핵심 행동 도달" },
    { label: "잔류·재방문", desc: "재방문·dormant 회수" },
    { label: "지지", desc: "친구 초대·공유" },
  ],
  "b2b-traditional": [
    { label: "인지", desc: "카테고리·회사 인지" },
    { label: "고려", desc: "리드 확보·nurturing" },
    { label: "구매", desc: "영업 미팅·SQL 전환" },
    { label: "잔류·확장", desc: "재계약·업셀" },
    { label: "지지", desc: "사례·추천" },
  ],
  "b2b-saas": [
    { label: "인지", desc: "카테고리 검색·콘텐츠 유입" },
    { label: "고려·전환", desc: "Trial·데모 신청" },
    { label: "활성화", desc: "첫 가치 도달" },
    { label: "잔류·확장", desc: "Paid 전환·업셀" },
    { label: "지지", desc: "커뮤니티·추천" },
  ],
};

/* ------------------------------------------------------------
   "비즈니스 모델별 퍼널 흐름 한눈에 보기" 표의 열 제목. 4개 모델 중
   하나(B2C 커머스)의 단계명을 그대로 공용 헤더로 쓰면 B2C 앱·B2B SaaS의
   3번째 단계("활성화")가 "구매"로 보이는 등 모델별로 다른 개념이 같은
   이름 아래 섞여 보인다. 그래서 이 표에서만 쓰는 중립적인 이름을 따로 둔다.
   ------------------------------------------------------------ */
const FUNNEL_OVERVIEW_STAGE_LABELS = ["인지", "고려·전환", "전환·활성화", "잔류·확장", "지지"];
