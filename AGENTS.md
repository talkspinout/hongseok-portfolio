...
- `marketing-funnel-data.js`: 마케팅 퍼널 프레임워크 콘텐츠·체크 도구 공용 데이터 (공통 진단 13원칙, 4개 비즈니스 모델의 단계별 활동·KPI·실패 분기)
...
- `lab.html`: 개인 프로젝트 (마케팅 퍼널 프레임워크 카드 → `marketing-funnel.html`, Think2Brief 카드 → `think2brief-story.html`로 연결)
